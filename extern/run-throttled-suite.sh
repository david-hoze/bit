...
declare -A SPECIAL_TIMEOUTS=(
    ...
    [t1013-read-tree-submodule.sh]=600
    [t2013-checkout-submodule.sh]=600
    [t2400-worktree-add.sh]=600
    [t6423-merge-rename-directories.sh]=600
    [t6438-submodule-directory-file-conflicts.sh]=600
    [t7112-reset-submodule.sh]=600
    [t7610-mergetool.sh]=600
